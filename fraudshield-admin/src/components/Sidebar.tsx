import { LayoutDashboard, Users, AlertTriangle, LogOut, CreditCard, Award, ShoppingBag, Radio, Search, Flag, Database } from 'lucide-react';
...
const Sidebar = () => {
    ...
    const navItems = [
        ...
        { icon: Database, label: 'Global Database', path: '/global-database' },
